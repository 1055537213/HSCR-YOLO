...
DEFAULT_MODEL = REPO_ROOT / "ultralytics" / "cfg" / "models" / "11" / "yolo11l-p2-rfcg.yaml"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train YOLO11l-P2-RFCG on VisDrone.")
    parser.add_argument("--model", type=Path, default=DEFAULT_MODEL, help="YOLO11l-P2-RFCG model yaml.")
    ...
    parser.add_argument("--name", default="yolo11l-p2-rfcg-visdrone-img640")
...
def main() -> None:
    ...
    print("Training YOLO11l-P2-RFCG with arguments:")
