...
from ultralytics.nn.tasks import (ClassificationModel, DetectionModel, PoseModel, SceneGuidedDetectionModel,
                                  SegmentationModel,
...
class YOLO:
    ...
    def _new(self, cfg: str, task=None, verbose=True):
        ...
        if self.task == 'detect' and cfg_dict.get('scene_guided', False):
            self.model = SceneGuidedDetectionModel(cfg_dict, verbose=verbose and RANK == -1)
        else:
